...
<%
    ...
    response.addHeader("Content-Security-Policy", "default-src 'self'; script-src 'self' 'unsafe-inline';style-src 'self' 'unsafe-inline' http://fonts.googleapis.com/; font-src *; img-src *");
...
<head>
  ...
  //----
            ...
            int isDistrict = 0;
            int isUlb = 0;
            if(StringEscapeUtils.escapeJavaScript(request.getParameter("district")) != null ){
                pageToDisplay = StringEscapeUtils.escapeJavaScript(request.getParameter("district"));
                isDistrict = 1;
            }else if(StringEscapeUtils.escapeJavaScript(request.getParameter("ulb")) != null){
                pageToDisplay = StringEscapeUtils.escapeJavaScript(request.getParameter("ulb"));
                isUlb = 1;
            }
              ...
              if(StringEscapeUtils.escapeJavaScript(request.getParameter("status")) != null && request.getParameter("status").equals("editing"))
              {
                  status = "editing";
            ...
            if(StringEscapeUtils.escapeJavaScript(request.getParameter("month")) != null && StringEscapeUtils.escapeJavaScript(request.getParameter("year")) != null)
            {
        ...
        if(!status.equals("editing")){
            ...
            try {
                for(int i=0; i< allEvents.size(); i++)
                {
                      ...
                      out.println("events_title["+i+"] =\" "+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleEvent.getTitle())) + " \" ;");
                      out.println("events_title_kannada["+i+"] =\" "+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleEvent.getTitleKannada())) + " \" ;");
                      out.println("events_image["+i+"] =\"/resources?name="+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleEvent.getImagePath())) + " \" ;");
                      out.println("events_content["+i+"] =\" "+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleEvent.getEventsContent())) + " \" ;");
                      out.println("events_content_kannada["+i+"] =\" "+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleEvent.getEventsContentKannada())) + " \" ;");
          ...
          List<NewsFeed> listOfAllNews = news.getNewsFeed(pageToDisplay, year, monthName, status);
                              ...
                              for(int i=0; i< listOfAllNews.size(); i++){
                                  ...
                                  out.print("news_title["+i+"]=\""+StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleNews.getTitle()))+"\" ;");
                                  out.print("news_title_kannada["+i+"]=\""+StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleNews.getTitleKannada()))+"\" ;");
                                  ...
                                  if(extension != null && extension.length() > 2)
                                  {
                                      ...
                                      {
                                          out.print("news_link["+i+"]=\"/resources?name="+StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleNews.getLink()))+"\" ;");
                                          out.print("news_link_kannada["+i+"]=\"/resources?name="+StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleNews.getLinkKannada()))+"\" ;");
                                      }else{
                                  ...
                                  out.print("news_content_kannada["+i+"]=\""+StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleNews.getContentKannada()))+"\" ;");
                                  out.print("news_content["+i+"]=\""+StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleNews.getContent()))+"\" ;");
                              }
          ...
          List<Stories> allStories = story.getAllStories(pageToDisplay, monthName, year, 3, status);
                          ...
                          for(int i=0; i<allStories.size(); i++)
                          {
                                  ...
                                  out.print("stories_title["+i+"]=\""+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleStory.getTitle())) +"\" ;");
                                  out.print("stories_title_kannada["+i+"]=\""+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleStory.getTitleKannada())) +"\" ;");
                                  out.print("stories_content["+i+"]=\""+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleStory.getStoriesContent())) +"\" ;");
                                  out.print("stories_content_kannada["+i+"]=\""+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleStory.getStoriesContentKannada())) +"\" ;");
                                  out.print("stories_image["+i+"]=\"/resources?name="+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleStory.getImagePath())) +"\" ;");
                                  out.print("stories_link_kannada["+i+"]=\"/resources?name="+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(singleStory.getLinkKannada())) +"\" ;");
           ...
           List<MostReadArticles> allRecentArticles = recent.getAllRecentArticles(pageToDisplay, monthName, year, status);
                           ...
                           for(int i=0; i<allRecentArticles.size(); i++)
                           {
                                  ...
                                  out.print("recent_article_title["+i+"] = \""+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(article.getTitle())) +"\";");
                                  out.print("recent_article_title_kannada["+i+"] = \""+ StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(article.getTitleKannada())) +"\";");
            ...
            List<Miscellaneous> allMiscellaneous = rows.getAllMiscellaneous(pageToDisplay, monthName, year, status);
                          for(int i=0; i<allMiscellaneous.size(); i++)
                          {
                                  Miscellaneous row = allMiscellaneous.get(i);
                                               ...
                                               out.print("miscellaneous_title["+i+"]=\""+StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(row.getTitle()))+"\";");
                                               out.print("miscellaneous_title_kannada["+i+"]=\""+StringEscapeUtils.escapeHtml(StringEscapeUtils.escapeJavaScript(row.getTitleKannada()))+"\";");
    ...
    <link rel="stylesheet" id="custom-google-fonts-css"
          href="http://fonts.googleapis.com/css?family=Lato%7CRoboto+Condensed%7CRoboto%7CKarla%3A300%2C400%2C600%2C700&amp;ver=4.5.3"
    ...
    <ul id="dropdownDistrict" class="dropdown-content">
        ...
        <nav style="height: 10em; background-color: #009688;">
            <div class="nav-wrapper container">
                <div class="row">
                    <a href="index.jsp" class="left hide-on-small-and-down" style="margin-top: 0.5%; margin-left: 9%;">
                        <img src="images/gkLogo.png" style="height: 90px;">
                    </a>
                    <a href="index.jsp" class="brand-logo center" style="margin-top: 1%;">eMagazine
                        <span class="brand-logo center" style="margin-top: 18%;font-size: 0.4em;">Directorate of Municipal Administration</span>
                        <br/>
                ...
                <div class="row">
                    <span class="left hide-on-small-and-down" style="margin-top: -3.5em; margin-left: 7%;">
                        MRC/<%=year%>/<%=monthName%>-001
                    </span>
                    <span class="right hide-on-small-and-down" style="margin-top: -3.5em; margin-right: 14%;">
                        <%=monthName%> <%=year%>
                    </span>
                </div>
            </div>
...
<main>
            ...
            <div class="row">
                <div class="col s12 m4">
                    ...
                    <div class="card" id="story1_card_image">
                        <div class="card-content">
                            <span id="story1_title" style="line-height: 120%;" class="card-title teal-color"><!--story heading--></span>
                        </div>
                        <div class="card-image" style="max-height: 18em;">
            ...
            <div class="row">
                <div class="col s12 m4">
                    <div class="card" id="story2_card_image">
                        <div class="card-content">
                            <span id="story2_title" style="line-height: 120%;" class="card-title teal-color"><!--story heading--></span>
                        </div>
                        <div class="card-image" style="max-height: 18em;">
            ...
            <div class="row">
                ...
                <div class="col s12 m4">
                    ...
                    <div class="card" id="story3_card_image">
                        <div class="card-content">
                            <span id="story3_title" style="line-height: 120%;" class="card-title teal-color"><!--story heading--></span>
                        </div>
                        <div class="card-image" style="max-height: 18em;">
                ...
                <div class="col s12 m7"><br>
                    ...
                    <p><a class="waves-effect waves-light"
                          href="otherStories.jsp?status=editing&month=<%=monthName%>&year=<%=year%>">MORE STORIES</a>
                    </p>
                    <%} else {%>
                    <p><a class="waves-effect waves-light" href="otherStories.jsp?month=<%=monthName%>&year=<%=year%>">MORE
                        STORIES</a></p>
                    <%}%>
                    <!--Modal for story 3-->
    ...
    <!--USEFULL LINKS BUTTONS-->
    <a class="waves-effect waves-light btn red">Library</a>
    <a class="waves-effect waves-light btn red">Feedback</a>
    <a class="waves-effect waves-light btn red">Blog</a>
...
<footer class="page-footer" style="background-color: #048e81;">
    <div class="container">
        <div class="row">
            <div class="col l4 offset-l4 s12">
                <ul>
                    <li>
                        <a class="grey-text text-lighten-3" href="#"><img src="images/fb.png" height="40"/></a> &nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <a class="grey-text text-lighten-3 " href="#"><i class="material-icons dp48"
                                                                         style="color: black;font-size: 2.5em;">call</i></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a class="grey-text text-lighten-3 " href="#"><img src="images/wa.png" height="40"/> </a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="footer-copyright" style="background-color: #048e81;">
        <div class="container">
    ...
    function change_event(id) {
        ...
        if (language == 0) {
            ...
            if (events_content[id] != undefined) {
                ...
                document.getElementById("event_summary").innerHTML = events_content[id].substring(0, 50).replace(/\n/g, "<br") + " ...";
                //$("#event_modal_content").text(events_content[id].replace(/\n/g, br));
                //$("#event_modal_content").text(events_content[id].split("\n").join("<br/>"));
                document.getElementById("event_modal_content").innerHTML = events_content[id].replace(/\n/g, "<br>");
            }
...
//--------------------------------
            //alert(events_content[id].replace(/\n/g, "<br />"));
        } else if (language == 1) {
            ...
            for (var i = 0; i < newsfeed_length; i++) {
                ...
                if (news_title_kannada[i] != undefined && news_title_kannada[i] != " ") {
                    ...
                    if (news_content_kannada[i] == "null" || news_content_kannada[i] == " ")
                        ...
                        td.className = "waves-effect waves-light modal-trigger";
                        document.getElementById("upcoming_events_modal_content").innerHTML = news_content_kannada[i].replace(/\n/g, "<br>");
                    }
                    tr.appendChild(td);
        ...
        for (var i = 0; i < stories.length; i++) {
            ...
            if (language == 0) {
                ...
                if (stories_content[i] != undefined) {
                    document.getElementById(stories[i] + "_summary").innerHTML = stories_content[i].substring(0, 550).replace(/\n/g, "<br>") + "...";
                    document.getElementById(stories[i] + "_modal_content").innerHTML = stories_content[i].replace(/\n/g, "<br>");
                }
        ...
        if (language == 0) {
            for (var i = 0; i < miscellaneous_elements.length; i++) {
                ...
                if (miscellaneous_content[i] != undefined)
                    document.getElementById(miscellaneous_elements[i] + "_content").innerHTML = miscellaneous_content[i].replace(/\n/g, "<br>");
            ...
            for (var i = 0; i < 3; i++) {
                ...
                if (miscellaneous_content[i] != undefined)
                    document.getElementById(miscellaneous_elements[i] + "_content").innerHTML = "2." + miscellaneous_content_kannada[i].replace(/\n/g, "<br>");
                //miscellaneous_link_kannada
                if (miscellaneous_link[i] != undefined)
