            ...
            <form action="controller.jsp" method="post">
                <div class="rom">
                    ...
                    <div class="input-field col s12">
                        ...
                        <input name="ad1Link" id="ad1Link" type="text" length="64">
        ...
        <div class="container">
            <form action="controller.jsp" method="post">
                <div class="rom">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">language</i>
                        <input name="ad2Link" id="ad2Link" type="text" length="64">
        ...
        <div class="container">
            <form action="controller.jsp" method="post">
                <div class="rom">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">language</i>
                        <input name="ad3Link" id="ad3Link" type="text" length="64">
        ...
        <div class="container">
            <form action="controller.jsp" method="post">
                <div class="rom">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">language</i>
                        <input name="ad4Link" id="ad4Link" type="text" length="64">
