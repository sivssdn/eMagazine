        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=event&number=1" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix" hidden>subject</i>
                        <textarea class="materialize-textarea" name="event1ContentKannada"
                                  id="event1ContentKannada" hidden
                                  type="text"></textarea>
                        <label for="event1ContentKannada" hidden>Content in Kannada</label>
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Kannada File
                            <input name="event1Link" type="file">
                        </a>
                        <div class="file-path-wrapper">
                            <input class="file-path validate" type="text">
                        </div>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=event&number=2" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea class="materialize-textarea" name="event2ContentEnglish"
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix" hidden>subject</i>
                        <textarea class="materialize-textarea" name="event2ContentKannada"
                                  id="event2ContentKannada" hidden
                                  type="text"></textarea>
                        <label for="event2ContentKannada" hidden>Content in Kannada</label>
                    </div>
                    <br/><br/>
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Kannada File
                            <input name="event2Link" type="file">
                        </a>
                        <div class="file-path-wrapper">
                            <input class="file-path validate" type="text">
                        </div>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=event&number=3" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea class="materialize-textarea" name="event3ContentEnglish"
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix" hidden>subject</i>
                        <textarea class="materialize-textarea" name="event3ContentKannada"
                                  id="event3ContentKannada" hidden
                                  type="text"></textarea>
                        <label for="event1ContentKannada" hidden>Content in Kannada</label>
                    </div>
                    <br/><br/>
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Kannada File
                            <input name="event3Link" type="file">
                        </a>
                        <div class="file-path-wrapper">
                            <input class="file-path validate" type="text">
                        </div>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=event&number=4" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea class="materialize-textarea" name="event4ContentEnglish"
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix" hidden>subject</i>
                        <textarea class="materialize-textarea" name="event4ContentKannada"
                                  id="event4ContentKannada" hidden
                                  type="text"></textarea>
                        <label for="event4ContentKannada" hidden>Content in Kannada</label>
                    </div>
                    <br/><br/>
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                ...
                <div class="file-field input-field col s12">
                    <a class="btn"><i class="material-icons left">perm_media</i>Upload Kannada File
                        <input name="event4Link" type="file">
                    </a>
                    <div class="file-path-wrapper">
                        <input class="file-path validate" type="text">
                    </div>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=event&number=5" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea class="materialize-textarea" name="event5ContentEnglish"
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix" hidden>subject</i>
                        <textarea placeholder="Content in Kannada" name="event5ContentKannada"
                                  id="event5ContentKannada" hidden
                                  type="text"></textarea>
                        <label for="event5ContentKannada" hidden>Content in Kannada</label>
                    </div>
                    <br/><br/>
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Kannada File
                            <input name="event5Link" type="file">
                        </a>
                        <div class="file-path-wrapper">
                            <input class="file-path validate" type="text">
                        </div>
