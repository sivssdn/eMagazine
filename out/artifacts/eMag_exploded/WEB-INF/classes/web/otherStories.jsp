    ...
    <div class="container" style="width: 90%;">
        ...
        <div class="row">
            ...
            <div class="col s12 m3">
                <div class="card " id="story1_card_image">
                    <div class="card-content">
                        <span class="card-title teal-color" id="story1_title" style="line-height: 120%;"></span>
                    </div>
            ...
            <div class="col s12 m7">
                ...
                <div id="story1_modal" class="modal modal-fixed-footer ">
        ...
        <div class="row">
            ...
            <div class="col s12 m3">
                <div class="card" id="story2_card_image">
                    <div class="card-content">
                        <span class="card-title teal-color" id="story2_title" style="line-height: 120%;"></span>
                    </div>
                    <div class="card-image" style="max-height: 14em;">
                        <img id="story2_image"/>
                    </div>
            ...
            <!--Modal for event popup-->
            <div id="story2_modal" class="modal modal-fixed-footer ">
                <div class="modal-content">
        ...
        <div class="row">
            ...
            <div class="col s12 m3">
                <div class="card" id="story3_card_image">
                    <div class="card-content">
                        <span class="card-title teal-color" id="story3_title" style="line-height: 120%;"></span>
                    </div>
                    <div class="card-image" style="max-height: 14em;">
                        <img id="story3_image"/>
                    </div>
            ...
            <!--Modal for event popup-->
            <div id="story3_modal" class="modal modal-fixed-footer">
                <div class="modal-content">
        ...
        <div class="row">
            ...
            <div class="col s12 m3">
                <div class="card" id="story4_card_image">
                    <div class="card-content">
                        <span class="card-title teal-color" id="story4_title" style="line-height: 120%;"></span>
                    </div>
                    <div class="card-image" style="max-height: 14em;">
                        <img id="story4_image"/>
                    </div>
            ...
            <!--Modal for event popup-->
            <div id="story4_modal" class="modal modal-fixed-footer ">
                <div class="modal-content">
        ...
        <div class="row">
            ...
            <div class="col s12 m3">
                <div class="card" id="story5_card_image">
                    <div class="card-content">
                        <span class="card-title teal-color" id="story5_title" style="line-height: 120%;"></span>
                    </div>
                    <div class="card-image" style="max-height: 14em;">
                        <img id="story5_image"/>
                    </div>
            ...
            <!--Modal for event popup-->
            <div id="story5_modal" class="modal modal-fixed-footer ">
                <div class="modal-content">
        ...
        for (var i = 0; i < stories.length; i++) {
            ...
            if (language == 0) {
                ...
                if (stories_content[i] != undefined) {
                    document.getElementById(stories[i] + "_summary").innerHTML = stories_content[i].substring(0, 250).replace(/\n/g, "<br>") + "...";
